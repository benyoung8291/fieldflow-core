-- Fix the CASE/WHEN error in generate_service_orders_from_contracts
...
BEGIN
  ...
  LOOP
    BEGIN
      ...
      -- Build title and description - FIXED: avoid CASE in array operations
