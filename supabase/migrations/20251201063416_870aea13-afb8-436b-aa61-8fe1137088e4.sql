-- Fix service order status from invalid 'pending' to valid 'draft'
...
BEGIN
  ...
  LOOP
    BEGIN
      ...
      -- Create service order with all required fields (FIXED: changed 'pending' to 'draft')
      INSERT INTO service_orders (
        ...
        v_title,
        v_description,
        'draft',  -- FIXED: Changed from 'pending' to 'draft'
        'fixed_price',
        v_fixed_amount,
        v_estimated_hours,
        'medium',
