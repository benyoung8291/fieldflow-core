-- Drop and recreate the function without contract_line_item_id references
...
BEGIN
  ...
  LOOP
    ...
    -- We'll check in the generation history table instead since service_orders doesn't have line_item_id
    SELECT service_order_id INTO v_existing_order_id
    FROM contract_generation_history
