...
DROP FUNCTION IF EXISTS generate_service_orders_from_contracts(date, date, uuid);
DROP FUNCTION IF EXISTS generate_service_orders_from_contracts(uuid, date, date, uuid);

-- Create the corrected 4-parameter function
