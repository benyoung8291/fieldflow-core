-- Fix: Update return format to match frontend expectations
...
BEGIN
  -- Count total line items that match criteria
  ...
  RETURN jsonb_build_object(
    'summary', jsonb_build_object(
      'orders_created', v_generated_count,
