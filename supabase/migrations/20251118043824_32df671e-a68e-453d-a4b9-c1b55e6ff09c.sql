-- Create function to calculate next generation date based on frequency
...
-- Main function to generate service orders from contract line items
...
-- Add generated_from_date column to service_orders if it doesn't exist
ALTER TABLE service_orders 
ADD COLUMN IF NOT EXISTS generated_from_date DATE;