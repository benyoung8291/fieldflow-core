...
const Index = () => {
  ...
  return (
    <div className="min-h-screen bg-background">
          ...
          <div className="max-w-5xl mx-auto">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <div className="text-center">
                ...
                <p className="text-muted-foreground">Automate scheduling, invoicing, and payment collection to focus on growing your business.</p>
              </div>
              ...
              <div className="text-center">
                ...
                <p className="text-muted-foreground">Send professional invoices instantly and accept payments online with automated reminders.</p>
              </div>
              ...
              <div className="text-center">
                ...
                <p className="text-muted-foreground">Keep all customer info, job details, and team schedules in one centralized system.</p>
              </div>
            </div>
          </div>
        </div>
      ...
      {/* Coming Soon Section */}
      <section id="coming-soon" className="py-20 bg-muted/30">
        <div className="container mx-auto px-4">
      ...
      <section className="py-20 bg-primary text-primary-foreground">
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center space-y-6">
            <h2 className="text-3xl lg:text-4xl font-bold">Ready to grow your business?</h2>
          ...
          <div className="max-w-6xl mx-auto grid md:grid-cols-4 gap-8">
            <div>
              <div className="flex items-center gap-2 mb-4">
                ...
                <span className="font-bold">Service Pulse</span>
              </div>
