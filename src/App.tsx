      ...
      <BrandColorsProvider>
        <DataAccessLoggerProvider>
          <ViewModeProvider>
            ...
            <Route path="/worker-availability-calendar" element={isAuthenticated ? <ProtectedRoute><SupervisorProtectedRoute><PermissionProtectedRoute module={getRouteModule("/workers")}><WorkerAvailabilityCalendar /></PermissionProtectedRoute></SupervisorProtectedRoute></ProtectedRoute> : <Navigate to="/auth" replace />} />
